...
export default function FlipBookV2() {
      ...
      <div className="fb-frame">
        ...
        {anim && (
          <>
            ...
            {/* Top layer: full-width panel sweeps across like a real page turn */}
            <div
              className={`fb-panel fb-panel--${anim.dir}`}
              onAnimationEnd={onDone}
            >
              <div className="fb-face fb-face--front">
                <Img src={IMAGES[anim.from]} half="full" />
              </div>
            </div>
          </>
        )}
